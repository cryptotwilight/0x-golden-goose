...
export const config = {
  ...
  ensScoutName:      opt('ENS_SCOUT_NAME', 'scout.tradeclaw.eth'),
  ensRiskName:       opt('ENS_RISK_NAME', 'risk.tradeclaw.eth'),
  ensExecutorName:   opt('ENS_EXECUTOR_NAME', 'executor.tradeclaw.eth'),
